...
def take_turn(plan, dice=make_fair_die(), who = 'Someone', comments = False):
    ...
    while over != True:
        ...
        score, turn_total, over = action(turn_total, curr_roll_2)
        if over == True:
            action = hold
        #if comments == True:
            #commentate(action, curr_roll_2, score, turn_total, over, who)
...
def play(strategy, opponent_strategy):
    ...
    player_total, opponent_total = 0, 0

    def dice_used():
        if (player_total + opponent_total)%7 == 0:
            return make_fair_die(4)
        else:
            return make_fair_die(6)

    while (player_total < goal) and (opponent_total < goal):
        if who == 0:
            player_total += take_turn(strategy(player_total, opponent_total), dice_used(), who, True)
        else:
            opponent_total += take_turn(opponent_strategy(opponent_total, player_total), dice_used(), who, True)
        who = other(who)
    who = other(who)
    #print('The winner is: ')
    #print(who)
...
def make_roll_until_plan(turn_goal):
...
def averaged(fn, num_samples=1000):
    ...
    """
    def averaged_value_function(*args):
        i, total = 0, 0
        while i < num_samples:
            total += fn(*args)
            i += 1
        return total/num_samples
    return averaged_value_function
...
def run_strategy_experiments():
    ...
    x = eval_strategy_range(make_roll_until_strategy, 15, 25)
    y = eval_strategy_range(make_die_specific_strategy, 5, 15)
    z = eval_strategy_range(make_pride_strategy, 0, 10)
    print('make rolls until:')
    print(x)
    print('make 4-sided rolls until:')
    print(y)
    print('make margin:')
    print(z)
...
def make_pride_strategy(margin, turn_goal=20):
    ...
    """
    def strategy(player_score, opponent_score):
        if player_score - opponent_score >= margin:
            return make_roll_until_plan(turn_goal)
        else:
            if (player_score - opponent_score) >= 0:
                return make_roll_until_plan(margin - (player_score-opponent_score))
            else:
                return make_roll_until_plan((opponent_score-player_score) + margin)
    return strategy
...
def final_strategy(score, opponent_score):
    ...
    """
    if (score == 0):
        return make_roll_until_strategy(14)(score, opponent_score)
    
    elif (score == 99 ):
        return make_roll_until_strategy(1)(score, opponent_score)
    elif (score == 98):
        return make_roll_until_strategy(2) (score, opponent_score)
    elif (score == 97):
        return make_roll_until_strategy(3) (score, opponent_score)
    elif (score == 96):
        return make_roll_until_strategy(4)(score, opponent_score)
    elif (opponent_score >= 94 ):
        return make_roll_until_strategy(100-score)(score, opponent_score)
    elif (score+opponent_score)%7 == 0 :
        return make_die_specific_strategy(7,20)(score, opponent_score)

    
    elif ((score+opponent_score)%7 == 1):
        return make_roll_until_strategy(13)(score, opponent_score)
    elif ((score+opponent_score)%7 == 2):
        return make_roll_until_strategy(12)(score, opponent_score)
    elif ((score+opponent_score)%7 == 3):
        return make_roll_until_strategy(18)(score, opponent_score)
    elif ((score+opponent_score)%7 == 4):
        return make_roll_until_strategy(17)(score, opponent_score)
    elif ((score+opponent_score)%7 == 5):
        return make_roll_until_strategy(16)(score, opponent_score)
    elif ((score+opponent_score)%7 == 6):
        return make_roll_until_strategy(15)(score, opponent_score)
...
def run():
    ...
    x = compare_strategies(final_strategy)
    print(x)
